...
- arXiv provides fixed, citable versions of the papers.
- GitHub hosts the evolving source, figures, corrections, and supplementary notes.
- Public essays or note articles provide interpretive and accessible introductions.
