...
The basic variables of IFGT are information density $I$, information flow $J$, and information potential $\Phi$.
...
\item $J$: processing flow from the fast layer toward the slow layer, or the flow of log referencing.
...
$J$ is not merely information transmission.
...
That is: consciousness is not $I$ itself, not $J$ itself, not $\Phi$ itself.
...
There is difference, gradient forms, flow arises, and structure tends toward closure — but never closes completely.
...
Conversely, if the fast and slow layers fully separate, flow $J$ does not reach the slow layer. Processing occurs, but does not sediment as a referenceable log.
...
\begin{equation}
\text{Consciousness} \sim \text{Log Referencing}\!\left(I, J, \Phi, \Delta v, \mu, \tau, \mathcal{T}_{\Phi}\right)
\end{equation}
...
Consciousness is not reducible to $I$ alone, nor to $J$, $\Phi$, or $\Delta v$ alone.
