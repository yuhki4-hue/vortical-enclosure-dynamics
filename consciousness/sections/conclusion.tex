...
IFGT describes which logs are easily referenced through projected uses of information density $I$, information flow $J_I$, local log-referencing flow $J_{\log}$, and information potential $\Phi$.
...
Second, methods for mapping IFGT's $I$, $J_I$, $\Phi$ and the local flow $J_{\log}$ onto brain data and behavioral data must be refined.
