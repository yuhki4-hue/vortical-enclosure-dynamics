...
Third, how to map the IFGT definitions of $\Phi$, $I$, $J_I$, and the local flow $J_{\log}$ onto neural activity, linguistic report, and subjective report remains incomplete.
